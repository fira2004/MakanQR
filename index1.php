...
<head>
    ...
    <title>AI Smart Canteen Ordering System</title>
...
<header>
    <div class="logo">
        <a href="index.html"><img src="images/logo.png" alt="MakanQR" class="logo-image"></a>  
    </div>
    ...
    <nav>
        ...
        <a href="recommendation.html">AI Picks</a>
    </nav>
</header>
<section class="hero">
    ...
    <div class="hero-content">
        ...
        <div class="hero-buttons">
            ...
            <a href="recommendation.html" class="btn-secondary">AI Recommendations</a>
        </div>
